...
**BOUNDARY RULE:**
- UGCSkill murni mengatur **Fisika Kamera & Visual** (Misal: rasio 9:16, lensa HP, tanpa *bokeh*, distorsi wajah).
- Untuk **Naskah/Ide Cerita** konten vertikal, UGCSkill WAJIB berkolaborasi dengan **StorySkill**. Jangan mencampuradukkan penulisan plot dengan aturan optik ini.
...
### 9. Character Limit Override (The 1000-1200 UGC Bypass)
...
### 10. The Absolute Ban on Cinematic Camera Movements (Hukum Haram Pergerakan Sinematik di UGC)
*   **Haram Mutlak:** Saat UGCSkill aktif, Anda **DILARANG KERAS** menggunakan istilah pergerakan kamera sinematik kelas atas (seperti *dolly zoom, steadycam tracking, cinematic push-in, orbit relay, crane shot, drone sweep, rack focus anamorphic, slow-motion pan, 35mm film lens*). Jika video terlihat terlalu rapi/sinematik, penonton TikTok/Reels akan langsung mendeteksi "Iklan" dan memindai (*scroll*).
*   **Kamera HP Murah Wajib:** Fisika kamera WAJIB 100% menggunakan simulasi kamera HP mentah yang tidak stabil:
    - *Shaky 0.5x front-facing/rear-facing selfie camera micro-movements*
    - *Unpolished vlogger arm sway & natural hand tremor*
    - *Hard jump-cut mid-motion setiap 1.5-2 detik*
    - *Sudut pandang HP kasual, 0.5x fisheye distortion*
